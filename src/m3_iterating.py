...
def run_test_count_negatives():
    ...
    # Test 6:
    expected = 10
    actual = count_negatives((-1, -1, -1, -1, -2, -3, -4, -5, -6, -7, 10, 11, 12))
    print()
    ...
    # Test 7:
    expected = 2
    actual = count_negatives((-8, 11, 0, -533))
    print()
...
def run_test_count_short_ones():
    ...
    # Test 9:
    expected = 2
    seq = [[55.2, 9.8], [6.02, 9.11, 10, -31, -19], "We the People of the United States", [55]]
    actual = count_short_ones(seq)
    print()
